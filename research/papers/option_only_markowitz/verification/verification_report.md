...
- `artifacts` / `empirical summary exists`: research/papers/option_only_markowitz/tables/empirical_summary.json
...
- `data` / `input exists or is externally licensed: equity option feature store`: data/feature_store/option_greek_proxy_panel.parquet
- `data` / `input exists or is externally licensed: Greek quality summary`: data/feature_store/option_greek_quality.csv
- `data` / `input exists or is externally licensed: raw close panel`: data/universe/multi_raw_close.csv
- `data` / `input exists or is externally licensed: VIX complex`: data/universe/vix_complex.parquet
- `data` / `input exists or is externally licensed: VX futures curve`: data/universe/vx_futures_daily.parquet
...
- `data` / `VIX settlement audit artifact exists`: research/papers/option_only_markowitz/artifacts/vix_settlement_audit.csv
...
- `empirical` / `required-capital returns artifact exists`: research/papers/option_only_markowitz/artifacts/required_capital_returns.csv
...
- `empirical` / `factor-control raw inputs absent; generated regression artifacts used`: data/feature_store/option_greek_proxy_panel.parquet
...
- `paper` / `compiled PDF exists`: 415027
